...
const IndicatorSelector = ({
  ...
  useEffect(() => {
    ...
    const defaultLoc = currentInfo?.userInfo?.userLoc || "loc7";
    const defaultRed = currentInfo?.userInfo?.userTransport || "caminable";
    const defaultTime = currentInfo?.userInfo?.userTime || 5;
  ...
  }, [currentInfo?.indicators?.[indicatorName], currentInfo?.userInfo]);
