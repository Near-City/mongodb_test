"""
Django settings for proyecto_accesibilidad project.
...
SECRET_KEY = 'django-insecure-p%mtt3z4@sh+j3j=cu(e&m*ixh(z+*x66g05b9ie*2c=oe+7h5'
...
ROOT_URLCONF = 'proyecto_accesibilidad.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [Path(BASE_DIR, 'accesibilidad_valencia', 'templates').as_posix()],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
